    ...
    setup(props,context:SetupContext){
      ...
      const closeMask = (e: MouseEvent) => {
        ...
        return ()=>(
          <Teleport to="body">
              <Transition>
                <div ref="beamodalRef" class="beamodal" v-if={open} onClick={(e:MouseEvent)=>closeMask(e)}>
                  <div id="modal-container" class="beamodal__container">
                    <div class="beamodal__title">
                      ...
                      <span class="beamodal__icon--close bea-iconfont bea-icon-close-small" onClick={(e:MouseEvent)=>close(e)}></span>
                    </div>
