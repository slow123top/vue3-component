              ...
              <div id="modal-container" class="beamodal__container">
                ...
                {!slots.footer && (
                  <div class="beamodal__footer--button">
                    <button class="button--cancel" onClick={(e:MouseEvent)=>clickCancel(e)}>{props.cancelText}</button>
                    <button class="button--ok" onClick={(e:MouseEvent)=>clickOk(e)}>{props.okText}</button>
                  </div>
                )}
              </div>
            </div>
