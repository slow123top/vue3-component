...
import type { SetupContext, Teleport, Transition } from "vue";
...
export default defineComponent({
  ...
  setup(props, context: SetupContext) {
    ...
    return () =>
      props.open && (
        <Transition
        enterActiveClass="bea-enter-active"
        leaveActiveClass="bea-leave-active"
        enterFromClass="bea-enter-from"
        leaveToClass="bea-leave-to"
        >
          <div
            ref={beamodalRef}
            class="beamodal"
